...
class Interest(Base):
    ...
    parent_id = Column(UUID(as_uuid=True), ForeignKey("interest.interest_id"), nullable=True)
...
class UserInterest(Base):
    ...
    interest_id = Column(UUID(as_uuid=True), ForeignKey("interest.interest_id"), nullable=False)
